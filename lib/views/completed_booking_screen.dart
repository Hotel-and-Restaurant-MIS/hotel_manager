...
import '../controllers/views/completed_booking_screen/completed_booking_state_controller.dart';

class CompletedBookingScreen extends StatelessWidget {
  Booking booking;
  CompletedBookingStateController _cbsc =
      CompletedBookingStateController.instance;

  CompletedBookingScreen({required this.booking}) {}
  @override
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Padding(
                  ...
                  child: Container(
                    decoration:
                        BoxDecoration(color: Colors.grey.withOpacity(0.2),borderRadius: BorderRadius.circular(5.0)),
                    child: Column(
                      children: <Widget>[
                        Row(
                          children: [
              ...
              ViewBookingItemTile(
                  tileName: 'Booking Status', tileValue: booking.bookingStatus),
              ViewBookingItemTile(
              ...
              ViewBookingItemTile(
                  ...
                  tileValue:
                      DateFormat('yyyy/MM/dd').format(booking.depatureDate)),
              ViewBookingItemTile(
